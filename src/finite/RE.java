...
abstract class RE implements Services {
  ...
  final String TikZ() {
    return new TikZifier() {
      @Override String traverse() {
        Abstracter<String> ¢ = extracted();
        extract(¢);
        String string = this.toString(); 
        return string;
      }
      Abstracter<String> extracted() {
        Abstracter<String> ¢ = new Abstracter<String>() {
          @Override public String and() { return "\\circ"; }
  ...
  abstract <T> void extract(Abstracter<T> ¢);
  ...
  abstract static class Binary extends RE {
    ...
    @Override final <T> void extract(final Abstracter<T> ¢) { ¢.binary(kind(¢), r1, r2); }
    Binary(final RE r1, final RE r2) { this.r1 = r1; this.r2 = r2; }
    final RE r1, r2;
    static final class And extends Binary {
      @Override public <T> T kind(final Abstracter<T> ¢) { return ¢.and(this); }
  ...
  abstract static class Nullary extends RE {
    ...
    @Override public final <T> void extract(final Abstracter<T> ¢) { ¢.nullary(kind(¢)); }
  ...
  abstract static class Unary extends RE {
    ...
    final <T> void extract(final Abstracter<T> ¢) { ¢.unary(kind(¢), r); }
    Unary(final RE r) { this.r = r; }
    final RE r;
    static final class Not extends Unary {
      @Override public <T> T kind(final Abstracter<T> ¢) { return ¢.not(); }
    ...
    static final class Plus extends Unary {
      @Override public <T> T kind(final Abstracter<T> ¢) { return ¢.plus(); }
      @Override public <T> T reduce(final Reducer<T> ¢) { return ¢.plus(r.reduce(¢)); }
      @Override public String toString() { return r + "+"; }
      Plus(final RE r) { super(r); }
    }
    static final class Star extends Unary {
      @Override public <T> T kind(final Abstracter<T> ¢) { return ¢.star(); }
      @Override public <T> T reduce(final Reducer<T> ¢) { return ¢.star(r.reduce(¢)); }
      @Override public String toString() { return r + "*"; }
