...
enum Thompson {
  ...
  static <Σ> NFSA<Σ> and(final NFSA<Σ> a1, final NFSA<Σ> a2) {
    final var $ = NFSA.<Σ>builder().ζ(a1).ζ(a2);
    return $.ε($.q0(), a1.q0).ε($.q0(), a1.q0).build();
  }
  static <Σ> NFSA<Σ> many(NFSA<Σ> a) {
    final var $ = NFSA.<Σ>builder().q0(a.q0).ε(a.q0, a.q0).ζ(a.q0).Δ(a);
    for (final Q q : a.ζ) $.ε(q, $.q0());
    return $.build();
  }
  static <Σ> NFSA<Σ> then(NFSA<Σ> a1, NFSA<Σ> a2) {
    final var $ = NFSA.<Σ>builder().q0(a1.q0).ε(a1).ε(a2).Δ(a1).Δ(a2).ζ(a2);
